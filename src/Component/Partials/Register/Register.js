...
import './Register'
function Register({loginModal, setLoginModal, registerModal , setRegisterModal , forgotPassswordModal , setForgotPassswordModal }) {
  ...
  return (
    <div className='bg'>
    {
      closeModal &&  <div data-aos="fade-down" className="modal fade" id="loginModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div className="modal-dialog modal-dialog-centered modal-lg">
            <div className="modal-content">
                <div className="close-icon">
                    <button onClick={CloseModal} type="button" className="closeModalBtn" data-bs-dismiss="modal" aria-label="Close"><svg
                    ...
                    <form action="">
                        <div className="login">
                            ...
                            <div className="login-btn">
                                <button type="submit" className="w-100 btn btn-brand">Create</button>
                            </div>
                            <div className="login-btn">
                            ...
                            <div className="wlcm">
                                <p className="haveAcount">Have your any account? <span data-bs-toggle="modal"
